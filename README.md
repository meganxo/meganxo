...
![Security](https://img.shields.io/badge/Security-AES--256--GCM%20%7C%20YubiKey%20SSH-green)
...
```text
Languages:       TypeScript, Swift, Python 3.11, JavaScript (ESM), SQL (PostgreSQL), HTML5, CSS3, Bash/Shell
Frontend/Web:    Next.js 14 (App Router), React 19, React Router 7, TailwindCSS, Vite 8, Electron
Mobile & Audio:  SwiftUI, Metal Compute Shaders, PencilKit, ARKit, AVAudioEngine, CoreML, CapacitorJS
